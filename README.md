...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-w5yijrs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-w5yijrs.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-w5yijrs.git
cd container-w5yijrs
```
...
```
docker attach container-w5yijrs
```
